#!/usr/bin/bash
# SLURM options:
#SBATCH --job-name=scaling_rel    # Job name
...
python /pbs/throng/lsst/users/cpayerne/CLCosmo_Sim/cluster_scaling_relation_DC2/modules/run_mcmc_cluster_scaling_relation_from_lensing_profiles.py MxN $ID
