...
#            continue
    ...
    #if _config_extract_sources_in_cosmoDC2.save_catalog=='True':
    #    save_pickle(dat_extract, _config_extract_sources_in_cosmoDC2.where_to_save_catalog + name_cat + '.pkl')
    ...
    if _config_extract_sources_in_cosmoDC2.compute_individual_lensing_profile=='True':
        ...
        for label_ in _config_lensing_profiles.label_pz:
            if label_ != 'true':
                ...
                mask_z = dat_extract_mag_cut['z'] > z + _config_lensing_profiles.Dz_background
