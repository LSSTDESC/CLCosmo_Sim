...
for index_split in np.arange(n_splits):
    ...
    cmd =   f'python run_extract_sources_in_cosmoDC2_vary_cosmology.py --index_split {index_split} --n_splits {n_splits} '
    ...
    file1 = f'/pbs/throng/lsst/users/cpayerne/CLCosmo_Sim_database/data_vary_fuducial_cosmology/ind_profile_redmapper_per_cluster_index/ind_profile_redmapper_split={index_split}_nsplits={n_splits}_ncl=71.pkl'
